	...
	<div class="container">
		...
		<div class="content-results">
			...
			<p>Questo gestionale è stato progettato per amministrare facilmente il database di una nota compagnia
				telefonica. L'obiettivo è gestire tutti i contratti telefonici stipulati dalla compagnia, la relativa
				lista delle chiamate effettuate da ogni numero e la totalità delle SIM. Ogni SIM può essere attiva,
				disattiva o non attiva. L'utente può aggiungere nuovi contratti, specificando il numero di telefono, la
				data di attivazione, la tipologia di contratto (a ricarica / a consumo) e gli eventuali credito/minuti
