		...
		<div id="myModal" class="modal">
			<div class="modal-content">
				...
				<form id="updateForm">
					...
					<span id="tipoWarning" class="warning" style="color:#800000; display:none;">Campo
						obbligatorio</span><br><br>
					...
					<input type="text" name="MinutiResidui" id="MinutiResidui" class="modal-input"
						style="display: none;" />
					<span id="minutiResiduiWarning" class="warning" style="color:#800000; display:none;">Campo
						obbligatorio</span><br><br>
					...
					<input type="text" name="CreditoResiduo" id="CreditoResiduo" class="modal-input"
						style="display: none;" />
					<span id="creditoResiduoWarning" class="warning" style="color:#800000; display:none;">Campo
						obbligatorio</span><br><br>
	...
	<div id="myModal3" class="modal">
		<div class="modal-content">
			...
			<form id="createForm">
				...
				<span id="numeroWarning" class="warning" style="color:#800000; display:none;">Campo
					obbligatorio</span><br><br>
				...
				<span id="dataAttivazioneWarning" class="warning" style="color:#800000; display:none;">Campo
					obbligatorio</span><br><br>
				...
				<input type="text" name="MinutiResidui" id="MinutiResidui2" class="modal-input"
					style="display: none;" />
				<span id="minutiResiduiWarning" class="warning" style="color:red; display:none;">Campo
					obbligatorio</span><br><br>
				...
				<input type="text" name="CreditoResiduo" id="CreditoResiduo2" class="modal-input"
					style="display: none;" />
				<span id="creditoResiduoWarning" class="warning" style="color:red; display:none;">Campo
					obbligatorio</span><br><br>
						...
						if (!$error) {
							if ($result->rowCount() > 0) {
								foreach ($result as $riga) {
									...
									?>
									<td><a href="SIM.php?StatoSIM=SIMAttiva&Codice=<?php echo $SIMAttiva ?>"><?php echo $SIMAttiva; ?></a>
									</td> <?php
								}
							} else {
								$SIMAttiva = "";
